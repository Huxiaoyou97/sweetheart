...
export const XY_CONFIG = resolve(CWD, 'sweetheart.config.js')
...
export const SITE_DIR = resolve(CWD, '.xy/site')
export const SITE_PC_ROUTES = resolve(CWD, '.xy/pc.routes.ts')
export const SITE_MOBILE_ROUTES = resolve(CWD, '.xy/mobile.routes.ts')
export const SITE_CONFIG = resolve(CWD, '.xy/site.config.json')
